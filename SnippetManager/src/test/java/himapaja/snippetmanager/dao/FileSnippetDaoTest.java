...
public class FileSnippetDaoTest {
    ...
    public void givenFileIsCreatedIfMissing() {
        fileSnippetDao.create(new Snippet(1, 1024, "testisnippet", "leikkikoodi-on-tässä", new ArrayList<>()));
    ...
    public void classWritesOneSnippetToFileCorrectly() throws Exception {
        fileSnippetDao.create(new Snippet(0, 1024, "testisnippet", "leikkikoodi-on-tässä", new ArrayList<>()));
    ...
    public void classWritesManySnippetsToFileCorrectly() throws Exception {
        for (int i = 1; i < 11; i++) {
            fileSnippetDao.create(new Snippet(i, 1024, "testisnippet" + i, "leikkikoodi-on-tässä", new ArrayList<>()));
        }
        Scanner tiedostonlukija = new Scanner(new File(file));
