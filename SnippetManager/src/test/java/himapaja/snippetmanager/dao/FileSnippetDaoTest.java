...
public class FileSnippetDaoTest {
    ...
    public void givenFileIsCreatedIfMissing() {
        fileSnippetDao.create(new Snippet("testisnippet", "leikkikoodi-on-tässä"));
    ...
    public void classWritesOneSnippetToFileCorrectly() throws Exception {
        ...
        assertEquals("0-,-testisnippet-,-leikkikoodi-on-tässä", tiedostonlukija.nextLine());
    ...
    public void classWritesManySnippetsToFileCorrectly() throws Exception {
        for (int i = 1; i < 11; i++) {
            fileSnippetDao.create(new Snippet("testisnippet" + i, "leikkikoodi-on-tässä"));
        }
        Scanner tiedostonlukija = new Scanner(new File(file));
        assertEquals("10", tiedostonlukija.nextLine());
        for (int i = 1; i < 11; i++) {
            String haetaan = (i - 1) + "-,-testisnippet" + i + "-,-" + "leikkikoodi-on-tässä";
