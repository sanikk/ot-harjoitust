...
public class SnippetTest {
    ...
    public void snippetFileConstructorIdNameLIdCode() throws Exception {
        ...
        LanguageService ls = new LanguageService(new FileLanguageDao(file2));
        ls.createLanguage("Pori");
        Snippet testeri = new Snippet(rivi, ls);
    ...
    public void snippetGivesTags() {
        ...
        lista.add("hello");
        lista.add("world");
        Snippet tester = new Snippet(3, 256, "testing", "best code ever", lista);
